...
\newcommand{\latexcommand}[1]{
  \lstinline[language={[LaTeX]TeX},basicstyle=\ttfamily]{#1}
}

\newcommand{\editbox}[2]{
  %% use reply to papers structures
}

\newcommand{\editboxwithlatex}[2]{
  %% use reply to papers structures
}
...
%% for in-line renderings
%% https://tex.stackexchange.com/questions/128399/print-small-tex-code-verbatim-and-render-it?noredirect=1&lq=1
\usepackage{stringstrings}
\usepackage{readarray}

\newcommand\showcase[1]{{\ttfamily\detokenizeplus{#1}} $\left(#1\right)$\unskip}

\newcommand\showlatex[1]{{\ttfamily\detokenizeplus{#1}}\unskip}

%% same as above but could change
\newcommand\showcommand[1]{{\ttfamily\detokenizeplus{#1}}\unskip}
